...
const systemPrompt = readFileSync(join(process.cwd(), "prompts/search.txt"), "utf-8");
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  while (true) {
    ...
    console.log("[search] stop_reason:", response.stop_reason);
    console.log("[search] content:", JSON.stringify(response.content, null, 2));
